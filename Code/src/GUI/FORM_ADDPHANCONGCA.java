...
public class FORM_ADDPHANCONGCA extends javax.swing.JFrame {
...
//        txtsoluong.setCaretColor(Color.WHITE);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("PHÂN CÔNG CA LÀM");

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Mã Ca");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "---MaCa----" }));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "----MaNV-----" }));
...
//       }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FORM_ADDPHANCONGCA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FORM_ADDPHANCONGCA().setVisible(true);
            }
        });
    }
