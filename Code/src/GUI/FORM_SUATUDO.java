...
public class FORM_SUATUDO extends javax.swing.JFrame {
...
//        }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtsotu, javax.swing.GroupLayout.PREFERRED_SIZE, 263, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel6)
                .addGap(18, 18, 18)
                .addComponent(txtsotu, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtmakh, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(27, 27, 27)
                .addComponent(jLabel7)
    ...
    private void jLabel2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MousePressed
      NumberFormat vnmoney = NumberFormat.getInstance(new Locale("vi", "vn"));
       ...
       if(txtsotu.getText().isEmpty()==false&&txtmakh.getText().isEmpty()==false&&txttenkh.getText().isEmpty()==false&&txtsdt.getText().isEmpty()==false)
       {
           if(ck.KT_SoLuong(txttenkh.getText())&&ck.KT_SoLuong(txtsdt.getText()))
           {
               if(Integer.parseInt(txttenkh.getText())>0&&Double.parseDouble(txtsdt.getText())>0)
               {
                   check=true;
               }
               else
      ...
      if(check==true)
      {
      String MaSP = txtsotu.getText() ;
       String TenSP =  txtmakh.getText();
       String SoLuong = txttenkh.getText();
       String Luong = txtsdt.getText();
...
//      }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FORM_SUATUDO().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTextField txtsotu;
